...
## 引用来源
- [1] [[raw/欧标/桩标准/IEC 61851-1-2017-1.md]] — 安规测试依据标准（EN 61851-1 的 IEC 原版），测试项目参数

## 变更记录
- 2026-07-20: 初始创建，搭建认证骨架
- 2026-07-22: 填充适用指令（LVD/EMC/RED）、测试项目（IP/绝缘/耐压/温升/湿热/RCD），来源 [[raw/欧标/桩标准/IEC 61851-1-2017-1.md]]
